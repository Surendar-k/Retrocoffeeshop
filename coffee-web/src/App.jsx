...
const OrderEntry = () => {
  ...
  // Retrieve cart from localStorage or location state
  const initialCart = JSON.parse(localStorage.getItem('cart')) || location.state?.cart || [];
  ...
  const handleBackToHome = () => {
    navigate('/', { state: { cart } }); // Pass cart state when navigating back
  };
